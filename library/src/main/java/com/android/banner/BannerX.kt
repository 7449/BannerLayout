...
fun BannerLayout.valueTransformerType(bannerTransformerType: Int) = also { this.bannerTransformerType = bannerTransformerType }
...
fun BannerLayout.valueVertical(isVertical: Boolean) = also { this.isVertical = isVertical }
