...
fun getTransformer(type: Int): BannerTransformer {
    when (type) {
        ...
        BannerTransformer.ANIMATION_FLIP_HORIZONTAL -> return FlipHorizontalTransformer()
        BannerTransformer.ANIMATION_FLIP_VERTICAL -> return FlipVerticalTransformer()
        BannerTransformer.ANIMATION_FOREGROUND -> return ForegroundToBackgroundTransformer()
        BannerTransformer.ANIMATION_ROTATE_DOWN -> return RotateDownTransformer()
        BannerTransformer.ANIMATION_ROTATE_UP -> return RotateUpTransformer()
        BannerTransformer.ANIMATION_SCALE_IN_OUT -> return ScaleInOutTransformer()
        BannerTransformer.ANIMATION_STACK -> return StackTransformer()
        BannerTransformer.ANIMATION_TABLET -> return TabletTransformer()
        BannerTransformer.ANIMATION_ZOOM_IN -> return ZoomInTransformer()
        BannerTransformer.ANIMATION_ZOOM_OUT_PAGE -> return ZoomOutPageTransformer()
        BannerTransformer.ANIMATION_ZOOM_OUT_SLIDE -> return ZoomOutSlideTransformer()
        BannerTransformer.ANIMATION_ZOOM_OUT -> return ZoomOutTransformer()
